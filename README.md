...
3. Use guardians to approve user request to recover user wallet.
...
## **Guardian Service**
Guardian services are an essential component of the **zkApp Keyless Wallet** to ensure the security of user's wallets. Here are three types of guardian services that can be used:
...
# **_Architecture_**
The **zkApp Keyless Wallet** architecture is a microservices-based architecture that consists of several services, including a wallet UI, guardian UI, wallet service, OTP service, secret saver service, guardian service, crypto service, etc. The Wallet UI is a client app that could be a browser extentions or mobile UI. The Guardian UI is build in Next.js.
